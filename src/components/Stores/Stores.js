        ...
        <>
            <section className='stores'>
                <form
                    ...
                    onSubmit={storeAdd}>
                    <input
                        className='store__input speaker__input'
                        ref={store_name}
                        type='text'
                        name='store_name'
                    ...
                    <input
                        className='store__input speaker__input'
                        ref={store_map_address}
                        type='url'
                        name='store_map_address'
                        placeholder='Store map addres'
                        required
                    />
                    <button className='store__btn web-intro__btn' type='submit'>
                        Send
                    </button>
                </form>
                            ...
                            <li className='store__item'>
                                <div className='store__inner'>
                                    ...
                                    <button
                                        ...
                                        data-sid={e.store_id}
                                        onDoubleClick={storeDeleted}></button>
                                </div>
                                <address className='store__addres'>
                                    {e.store_addres}
                                </address>
                                <div className='store__item-inner'>
                                    <a
                                        className='store__link-tel'
                                        href={`tel:` + e.store_phonenumber}
                                        target='blank'>
                                        {e.store_phonenumber}
                                    </a>
                                    <a
                                        className='store__link-map'
                                        href={e.store_map_address}
                                        target='blank'>
                                        Xaritadan ko’rish
                                    </a>
                                </div>
