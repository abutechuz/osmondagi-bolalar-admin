          ...
          <nav className="site-navigation__nav nav">
            <ul className="nav__list">
              ...
              <li className="nav__item">
                ...
                >
                  <Statistik className="nav__link-svg" />
                  <span className="nav__link-span">Savollar</span>
                </NavLink>
              </li>
              <li className="nav__item">
                <NavLink
                ...
                >
                  <Statistik className="nav__link-svg" />
                  <span className="nav__link-span">Takliflar</span>
                </NavLink>
              </li>
              <li className="nav__item">
                <NavLink
                ...
                >
                  <Statistik className="nav__link-svg" />
                  <span className="nav__link-span">Speakerlar</span>
                </NavLink>
              </li>
              <li className="nav__item">
                <NavLink
                ...
                >
                  <Statistik className="nav__link-svg" />
                  <span className="nav__link-span">Foydalanuvchilar</span>
                </NavLink>
              </li>
              <li className="nav__item">
                <NavLink
                ...
                >
                  <Statistik className="nav__link-svg" />
                  <span className="nav__link-span">Posts</span>
                </NavLink>
              </li>
              <li className="nav__item">
                <NavLink
